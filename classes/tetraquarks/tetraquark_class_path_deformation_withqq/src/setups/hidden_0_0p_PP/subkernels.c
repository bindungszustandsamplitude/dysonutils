    ...
    for(size_t izp=0; izp<n_angular_z; ++izp){
        for(size_t iq=0; iq<n_radial; ++iq){
            for(size_t izq=0; izq<n_angular_z; ++izq){
                for(size_t ib2=0; ib2<nb4; ++ib2){
                    for(size_t ib4=0; ib4<nb4; ++ib4){
                        kernel[7][SI_K_07(ip,izp, nb1+ib2 , iq,izq, nb1+ib4)] = K44[SI_K44(ip,izp,ib2,iq,izq,ib4)];
}}}}}}
    ...
    for(size_t izp=0; izp<n_angular_z; ++izp){
        for(size_t iq=0; iq<n_radial; ++iq){
            for(size_t izq=0; izq<n_angular_z; ++izq){
                for(size_t ib2=0; ib2<nb4; ++ib2){
                    for(size_t ib4=0; ib4<nb4; ++ib4){
                        kernel[9][SI_K_09(ip,izp, nb2+ib2 , iq,izq, nb2+ib4)] = K44[SI_K44(ip,izp,ib2,iq,izq,ib4)];
}}}}}}
    ...
    for(size_t izp=0; izp<n_angular_z; ++izp){
        for(size_t iq=0; iq<n_radial; ++iq){
            for(size_t izq=0; izq<n_angular_z; ++izq){
                for(size_t ib2=0; ib2<nb4; ++ib2){
                    for(size_t ib4=0; ib4<nb4; ++ib4){
                        kernel[10][SI_K_10(ip,izp, nb3+ib2 , iq,izq, nb3+ib4)] = K44[SI_K44(ip,izp,ib2,iq,izq,ib4)];
}}}}}}
