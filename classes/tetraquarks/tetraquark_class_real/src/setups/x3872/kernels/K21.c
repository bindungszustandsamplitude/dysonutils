...
ampl01 = 0.5*(ns_data_v2::amplitudes::meson::vector::fit::m_1500_1500(0,std::real(l_l+p_l+0.25*p_p))
...
ampl10 = 0.5*(ns_data_v2::amplitudes::meson::vector::fit::m_1500_1500(0,std::real(l_l+p_l+0.25*p_p))
...
K21[SI_K21(ip,izp,0,iq,izq,0)] += wj * FCtr * w[15];
K21[SI_K21(ip,izp,0,iq,izq,1)] += wj * FCtr * w[22];
K21[SI_K21(ip,izp,0,iq,izq,2)] += wj * FCtr * w[16];
K21[SI_K21(ip,izp,1,iq,izq,0)] += wj * FCtr * w[32];
K21[SI_K21(ip,izp,1,iq,izq,1)] += wj * FCtr * w[33];
K21[SI_K21(ip,izp,1,iq,izq,2)] += wj * FCtr * w[14];
